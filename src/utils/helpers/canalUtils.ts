...
export type Canal = 'Coppel.com' | 'App Coppel' | 'Coppel.com en tienda';
...
const CLIENT_ID_CANAL_MAP: Record<string, Canal> = {
    // DEV
    'xgGLdRWkSewJyhSUxhFCAhznY66luTU8': 'App Coppel', // Android
    'keWX8LIckaFAfZijOyb0loGWWUvJZmmJ': 'App Coppel', // iOS
    'ER4kqxVJv5KMfJSMB8YEWvJ306HlKhn5': 'Coppel.com en tienda',
    'QYAgMKnChE6ljDAnAnrvkb99vSak4CI7': 'Coppel.com',

    // QA
    't1d57wX1oBx108H4zwvXe48ECLZ6dhln': 'App Coppel', // Android
    'BLBP9YAEGSgfBgQkiBEtHjOGqtDMyTwu': 'App Coppel', // iOS
    'MjgidPypr1Hq058uj1unf6lCH7xrh2I7': 'Coppel.com en tienda',
    'ihoBaCNCe0OvKfJPzm2qv33bouJ2VZI4': 'Coppel.com',

    // STA
    '2776QwsD9hU2O3GO53vXZZzCj0wLZDmu': 'App Coppel', // Android
    'RHI8WuQX3pbpB3ZWwhrzLJpggWpN8UFK': 'App Coppel', // iOS
    'uBtdnolFSamjofLcRKvYyR9t5xlUY4wv': 'Coppel.com en tienda',
    '5Rlem1oRt48wJA4vDoHEYKyA6byQjqR9': 'Coppel.com',

    // PROD
    '9F0BL6kJyKI5XWrMqzZE0Mv3CrsJU1lj': 'App Coppel', // Android
    'fYCHK31lNFHtTIpdDNgMVIZQ9iksDXau': 'App Coppel', // iOS
