 ...
 */
export declare function getActiveIdentifiers(transaction: TransactionContext): IdentifierType[] | null;
/**
 ...
 */
export declare function getAllowedIdentifiers(transaction: TransactionContext): TransactionMembersOnLoginId["allowedIdentifiers"] | null;
/**
